...
class ps3_P3(unittest.TestCase):
    ...
    def test_update_position_and_cleanStandardRobot(self):
        ...
        robot.position(test.Position(1.5, 2.5))
        robot.direction(90)
        robot.update_position_and_clean()
        self.assertEquals(robot.direction(), 90,
        ...
        self.assertTrue(robotPos.x() == correctPos.get_x() and robotPos.y() == correctPos.get_y(),
        ...
        self.assertNotEquals(robot.direction(), 90,
...
class ps3_P5_Standard(SimulationTester):
    ...
    def testSimulation1(self):
        ...
        try:
            self.run_simulation(((142, 173),), (1, 1.0, 1, 5, 5, 1, 1.0, 100, ps3.StandardRobot,ps3.EmptyRoom))
        except:
            print ("Unexpected error:", sys.exc_info()[1])
            raise
    def testSimulation2(self):
        "Test cleaning 75% of a 10x10 room (Standard Robot)"
        self.run_simulation(((183, 198),), (1, 1.0, 1, 10, 10, 1, 0.75, 100, ps3.StandardRobot,ps3.EmptyRoom))
    def testSimulation3(self):
        "Test cleaning 90% of a 10x10 room (Standard Robot)"
        self.run_simulation(((298, 327),), (1, 1.0, 1, 10, 10, 1, 0.9, 100, ps3.StandardRobot,ps3.EmptyRoom))
    def testSimulation4(self):
        "Test multiple robots (95% of a 20x20 room with 5 robots (Standard Robot))"
        self.run_simulation(((289, 303),), (5, 1.0, 1, 20, 20, 1, 0.95, 100, ps3.StandardRobot,ps3.EmptyRoom))
    def testSimulation5(self):
        "Test different speeds (90% of a 5x20 room with a robot of speed 0.2 (Standard Robot))"
        self.run_simulation(((1095, 1228),), (1, 0.2, 1, 5, 20, 1, 0.9, 100, ps3.StandardRobot,ps3.EmptyRoom))
    def testSimulation6(self):
        ...
        self.run_simulation(((155, 180),), (3, 0.5, 1, 10, 10, 1, 0.9, 100, ps3.StandardRobot,ps3.EmptyRoom))
    # new tests below here
    def testSimulation7(self):
         "Test cleaning 100% of a 5x5 room (Standard Robot, 5 dirt/tile, capcity = 3)"
         self.run_simulation(((206, 266),(180, 240)), (1, 1.0, 3, 5, 5, 5, 1.0, 100, ps3.StandardRobot,ps3.EmptyRoom))
    def testSimulation8(self):
        "Test cleaning 100% of a 5x5 room (Standard Robot, 6 dirt/tile, capacity = 3)"
        self.run_simulation(((206, 266),(180, 240)), (1, 1.0, 3, 5, 5, 6, 1.0, 100, ps3.StandardRobot,ps3.EmptyRoom))
    def testSimulation9(self):
        ...
        self.run_simulation(((387, 447),(384, 444)), (1, 0.2, 2, 3, 10, 6, 0.9, 100, ps3.StandardRobot,ps3.EmptyRoom))
    def testSimulation10(self):
        "Test multiple robots (95% of a 10x10 room with 5 robots (Standard Robot)) capacity = 2, 6 dirt/tile"
        self.run_simulation(((137, 198),(130, 190)), (5, 1.0, 2, 10, 10, 6, 0.95, 100, ps3.StandardRobot,ps3.EmptyRoom))
    def testSimulation11(self):
        ...
        self.run_simulation(((48, 108), (45, 104)), (3, 0.5, 2, 5, 5, 6, 0.9, 100, ps3.StandardRobot,ps3.EmptyRoom))
...
class ps3_P5_Faulty(SimulationTester):
    ...
    def testSimulation2(self):
        ...
        x = ps3.run_simulation(1, 1.0, 1, 10, 10, 1, 0.75, 100, ps3.FaultyRobot,ps3.EmptyRoom)
